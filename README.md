...
| Jan 31 (M) | - [SoftSKU: Optimizing Server Architectures for Microservice Diversity @Scale](https://dl.acm.org/doi/10.1145/3307650.3322227) <br/> - [Memory Hierarchy for Web Search](https://web.stanford.edu/~kozyraki/publications/2018.search.hpca.pdf) | Microarchitecture analysis | Guest: [Grant Ayers](https://research.google/people/GrantAyers/) (Google)| 2. Akshay Revankar |  
...
| April 13 (M) | - [Pocket: Elastic Ephemeral Storage for Serverless Analytics](https://www.usenix.org/system/files/osdi18-klimovic.pdf) <br/> - [The Google File System](https://static.googleusercontent.com/media/research.google.com/en//archive/gfs-sosp2003.pdf) | Datacenter storage | | 1. Nikhil Arora <br/> 2. Peizhao Li |
