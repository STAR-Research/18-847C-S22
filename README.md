...
| Feb 16 (M) <br/> ([lecture](https://ece.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=d22f4aa0-00b7-4385-a980-ae3e0181465c)) | - [uTune: Auto-Tuned Threading for OLDI Microservices](https://www.usenix.org/system/files/osdi18-sriraman.pdf) <br/> - [Few-to-Many: Incremental Parallelism for Reducing Tail Latency in Interactive Services](https://abelay.github.io/6828seminar/papers/haque:fewtomany.pdf) | Concurrency/Threading | Guest: [Md Haque](https://www.linkedin.com/in/md-ehtesam-haque-28b1a087/) (Google) | 1. Mihailo Rancic <br/> 2. Chenlyu Zhao |
