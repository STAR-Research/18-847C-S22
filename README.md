...
| Jan 31 (M) <br/> ([lecture](https://ece.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=5ed05a98-5ccf-4587-a459-ae2e01820762))| - [SoftSKU: Optimizing Server Architectures for Microservice Diversity @Scale](https://dl.acm.org/doi/10.1145/3307650.3322227) <br/> - [Memory Hierarchy for Web Search](https://web.stanford.edu/~kozyraki/publications/2018.search.hpca.pdf) | Microarchitecture analysis | Guest: [Grant Ayers](https://research.google/people/GrantAyers/) (Google)| 2. Akshay Revankar |  
