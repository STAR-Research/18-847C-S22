...
| Feb 2 (W) | - [Dagger: Efficient and Fast RPCs in Cloud Microservices with Near-Memory Reconfigurable NICs](https://www.csl.cornell.edu/~delimitrou/papers/2021.asplos.dagger.pdf) <br/> - [A hardware accelerator for protocol buffers](https://sagark.org/assets/pubs/protoacc-micro2021-preprint.pdf) | Accelerating data center tax | - Guest: [Sagar Karandikar](https://sagark.org/) (UC Berkeley) <br/> - Finalize project deliverables | 1. Sanil Rao <br/> 2. Balamurugan Marimuthu |
